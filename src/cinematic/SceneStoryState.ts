...
export const SCENE_STORY_BEATS = [
  ...
  { time: 26, name: 'Террасы с обратной стороны' },
...
export class SceneStoryState {
  ...
  update(input: number): this {
    ...
    this.presence = smootherstep(9, 24, t);
    this.illumination = smootherstep(9.5, 26, t)
      * (1 + pulse(20, 2.4, t) * .08);
    ...
    this.weather = smootherstep(9.5, 23, t);
