...
цитадель и чёрный полумесяц среди живых облаков. Непрерывный 36-секундный
пролёт ведёт от ночной улицы к террасам цитадели, мимо Гетсуги,
через белое небо к прежнему ракурсу цитадели справа, затем раскрывает остров.
Крупные облачные массы располагаются на разной глубине вокруг маршрута.
Повторяющиеся ракурсы камера проходит быстрее, затем замедляется перед
ключевыми видами. Гетсуга растёт цельной плотной пластиной во время облёта,
облака сгущаются и размываются, а свет постепенно меняет окружающий город.
Один плеер: семь закладок останавливают сцену, Play продолжает с выбранного места.
В финале камера замирает, но облака продолжают жить до общей паузы.

**[Парящий город](https://bleach-webgpu.vercel.app/?film=tour&frame=7&paused)** ·
...
- Единый плеер и семь закладок, быстрые переходы с приближением и размазыванием цвета, общая пауза и скрытие панели.

Главная сохраняет закреплённую камеру и открывает плеер кнопкой «Смотреть кино».
...
1–7 и стрелки ←/→ выбирают закладку. Play / P продолжает кино с неё;
пауза останавливает всю сцену. H скрывает и возвращает панель. Шкала времени
доступна всегда. Предпочтение уменьшенного движения учитывается.
