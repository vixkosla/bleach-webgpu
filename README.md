...
Сцена строится и освещается в реальном времени; камерой можно свободно управлять.
...
Основной режим — свободный осмотр. Исторический 26-секундный cinematic доступен
...
Если WebGPU недоступен, приложение показывает сообщение вместо 3D-сцены.
