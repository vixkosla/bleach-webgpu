...
ключевыми видами. Кнопка «Звук» включает свист на ускорениях.
В режиме «Кадры» камера удерживает один из девяти ракурсов, а атмосфера
...
- «Кино» и девять живых «Кадров», быстрые переходы с приближением и размазыванием цвета, пауза атмосферы и скрытие панели.
