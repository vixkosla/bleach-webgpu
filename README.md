...
через белое небо и вниз к скале перед раскрытием всего острова.
В режиме «Кадры» камера удерживает один из двенадцати ракурсов, а атмосфера
...
- «Кино» и двенадцать живых «Кадров», быстрые переходы с приближением и размазыванием цвета, пауза атмосферы и скрытие панели.
