...
В режиме «Кадры» камера удерживает один из семи ракурсов, а атмосфера
...
- «Кино» и семь живых «Кадров», быстрые переходы с приближением и размазыванием цвета, пауза атмосферы и скрытие панели.
